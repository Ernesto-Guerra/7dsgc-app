...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="text-black/50 dark:bg-black dark:text-white/50 bg-center bg-cover"
        style="background-image: url('https://pbs.twimg.com/media/GC-uIwkbwAA47xV.jpg:large')">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    @if (Route::has('login'))
                    <div
                        class="col-span-full p-2 align-items-center bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                        @auth
                        <a href="{{ url('/dashboard') }}"
                            class="flex justify-center rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            Dashboard
                        </a>
                        @else
                        <a href="{{ route('login') }}"
                                ...
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            Laravel has wonderful documentation (or not) covering every aspect of the
                                            framework. Whether you are a newcomer or have prior experience with Laravel,
                                            we recommend reading our documentation from beginning to end.
                                        </p>
                                    </div>
                                </div>
